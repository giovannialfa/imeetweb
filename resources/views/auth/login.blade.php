        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4 offset-md-4">
                    <div class="welcome" style="margin-top: 49px;">WELCOME!</div>

                    <form method="POST" action="{{ route('login') }}">
                        @csrf

                        <div class="form-group row" style="margin-top: 70px;  border-radius: 4px;">
                            <div class="col-md-2">
                        ...
                        <div class="form-group row" style="margin-top: 10px;  border-radius: 4px;">
                            <div class="col-md-2">
